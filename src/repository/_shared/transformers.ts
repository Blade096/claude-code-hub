...
export function toProvider(dbProvider: any): Provider {
  return {
    ...
    remoteCompactionV2: dbProvider?.remoteCompactionV2 ?? false,
    codexMultiAgentV2Mode: dbProvider?.codexMultiAgentV2Mode ?? "native",
...
export function toSystemSettings(dbSettings: any): SystemSettings {
  ...
  return {
    ...
    enableCodexMultiAgentV2Compatibility: dbSettings?.enableCodexMultiAgentV2Compatibility ?? false,
